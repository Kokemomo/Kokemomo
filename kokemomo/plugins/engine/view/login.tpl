...
<html lang="ja">
    <head>
        ...
        <script src='{{url('engine', "static_js", "communication.js")}}'></script>
        <script src='{{url('engine',"static_js", "login.js")}}'></script>
        <link href='{{url('engine',"static_css", "login.css")}}' rel="stylesheet">
    </head>
    <body>
